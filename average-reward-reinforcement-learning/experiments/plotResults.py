...
def plot_results_from_dump(cumRegretfiles, tplot,folder="results/",logfile=''):
    """
    ...
    plotCumulativeRegrets(learnerNames, envName, median, quantile1, quantile2, times, tplot, logfile=logfile)
