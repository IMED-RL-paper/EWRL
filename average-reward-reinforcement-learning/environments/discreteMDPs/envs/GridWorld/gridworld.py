...
#    metadata = {'render.modes': ['text', 'pylab', 'maze'], 'maps': ['random','2-room', '4-room']}
    ...
    def __init__(self, sizeX,sizeY, map_name="random", slippery=0.1,nbGoals=1,rewardStd=0.,density=0.2, lengthofwalks=5, initialSingleStateDistribution=False,seed=None,name="GridWorldWithWall"):
        """
...
class GridWorld(DiscreteMDP):
 #   metadata = {'render.modes': ['text', 'ansi', 'pylab', 'maze'], 'maps': ['random', '2-room', '4-room']}
    ...
    def __init__(self, sizeX, sizeY, map_name="random", slippery=0.1, nbGoals=1, rewardStd=0., density=0.2,
                 lengthofwalks=5, initialSingleStateDistribution=False,seed=None,name="GridWorld"):
        """
